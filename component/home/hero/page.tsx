      ...
      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
        <div>
          ...
          <button
            data-aos="fade-up"
            data-aos-delay="300"
            className="px-8 py-3 rounded-full mt-10 ml-0 md:ml-12 text-white 
            font-semibold cursor-pointer hover:bg-[#9f7c4e] transition-all duration-300 outline-2 outline-gray-300"
          >
            Discover More
          </button>
        </div>
